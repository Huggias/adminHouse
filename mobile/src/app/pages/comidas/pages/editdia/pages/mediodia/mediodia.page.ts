...
@Component({
  selector: 'app-mediodia',
  templateUrl: './mediodia.page.html',
  styleUrls: ['./mediodia.page.scss'],
})
export class MediodiaPage implements OnInit {
  public menus;
  public usuarios;
  public dia;
  public datos;
  ...
  async ngOnInit() {
    ...
    this.service.getMenuDia(this.dia, "mediodia").subscribe(
      res => {
        this.datos = res[0];
